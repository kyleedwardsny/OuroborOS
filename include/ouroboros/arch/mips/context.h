...
#define TLB_ENTRY_ACCESS_ENTRY_LO1_OFFSET	(GPR_SIZE * 2)
#define TLB_ENTRY_ACCESS_ENTRY_HI_OFFSET	(GPR_SIZE * 3)
#define TLB_ENTRY_ACCESS_PAGE_MASK_OFFSET	(GPR_SIZE * 4)
